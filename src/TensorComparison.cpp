...
// Helper macro to generate unified comparison functions
#define DEFINE_COMPARISON_UNIFIED(func_name, cuda_func_float32, cuda_func_float64) \
// [[Rcpp::export]] \
SEXP func_name(SEXP a_ptr, SEXP b_ptr) { \
    TRY_CATCH \
    { \
        ...
        switch (dtype) { \
            case DType::FLOAT32: { \
                ...
                cuda_func_float32(result_gpu->data(), a_contig.data(), b_contig.data(), result_gpu->size()); \
            ...
            case DType::FLOAT64: { \
                ...
                cuda_func_float64(result_gpu->data(), a_contig.data(), b_contig.data(), result_gpu->size()); \
...
// TRY_CATCH macro definitions for consistency
...
// Generate three unified comparison functions
DEFINE_COMPARISON_UNIFIED(tensor_gt_unified, tensor_gt_float32, tensor_gt_float64)
DEFINE_COMPARISON_UNIFIED(tensor_lt_unified, tensor_lt_float32, tensor_lt_float64)
DEFINE_COMPARISON_UNIFIED(tensor_eq_unified, tensor_eq_float32, tensor_eq_float64) 